...
import 'package:moshal/task.dart';
...
class TodoState extends State<Todo> {
  ...
  Widget _myHeaderContent(){
    return Align(
      child: ListTile(
        leading: Text(date.day.toString(), style: TextStyle(fontSize: 50.0, color: Colors.amber)),
        title: Text(_month(date.month), style: TextStyle(fontSize: 34.0, color: Colors.white)),
        subtitle: Text(date.year.toString(), style: TextStyle(fontSize: 24.0, color: Colors.white)),
      ),
    );
  }
}